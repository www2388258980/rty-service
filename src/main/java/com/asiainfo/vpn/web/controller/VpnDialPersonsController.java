...
public class VpnDialPersonsController {
    ...
    public OperationResult<VpnDialPersons> getVpnDailPersonsBykey(String id) {
        OperationResult<VpnDialPersons> or = null;
        try {
    ...
    public OperationResult<Boolean> updateVpnDialPersons(VpnDialPersons persons) {
        OperationResult<Boolean> or = null;
        try {
            // 转换
