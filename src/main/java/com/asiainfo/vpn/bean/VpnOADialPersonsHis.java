...
public class VpnOADialPersonsHis {
    ...
    public void setOldFirstName(String oldFirstName) {
        this.oldFirstName = oldFirstName == null ? null : oldFirstName.trim();
    }

    public String getOldTelecomNumber() {
        return oldTelecomNumber;
    }
    ...
    public void setOldDescription(String oldDescription) {
        this.oldDescription = oldDescription == null ? null : oldDescription.trim();
    }

    public String getOldFirstChar() {
        return oldFirstChar;
    }

    public void setOldFirstChar(String oldFirstChar) {
    ...
    public void setOldCreatedBy(String oldCreatedBy) {
        this.oldCreatedBy = oldCreatedBy == null ? null : oldCreatedBy.trim();
    }

    public String getOldModifiedBy() {
        return oldModifiedBy;
    }

    public void setOldModifiedBy(String oldModifiedBy) {
    ...
    public String getOldModifiedBillId() {
        return oldModifiedBillId;
    }

    public void setOldModifiedBillId(String oldModifiedBillId) {
