...
Date: 2019-09-11 14:53:04
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for vpn_oa_dial_persons
-- ----------------------------
DROP TABLE IF EXISTS `vpn_oa_dial_persons`;
CREATE TABLE `vpn_oa_dial_persons` (
  ...
  `VPN_TYPE_ID` varchar(255) DEFAULT NULL,
